...
stats_file = path.join( stats_dir, 'CDS_column_stats_by_table.as_extracted.tsv' )
...
with open( stats_file, 'w' ) as STATS_FILE:
    ...
    print( 'Tabulating stats for all extracted CDS fields...', end='\n\n', file=sys.stderr )
    ...
    print( '\n...done computing general stats on extracted CDS field values.', end='\n\n', file=sys.stderr )
