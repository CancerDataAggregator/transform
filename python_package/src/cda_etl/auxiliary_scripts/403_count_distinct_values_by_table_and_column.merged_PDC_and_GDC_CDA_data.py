...
input_root = path.join( 'cda_tsvs', 'merged_gdc_and_pdc_tables' )

aux_root = 'auxiliary_metadata'

stats_dir = path.join( aux_root, '__column_stats' )

stats_file = path.join( stats_dir, 'GDC_and_PDC_column_stats_by_table.converted_to_CDA_and_merged.tsv' )
