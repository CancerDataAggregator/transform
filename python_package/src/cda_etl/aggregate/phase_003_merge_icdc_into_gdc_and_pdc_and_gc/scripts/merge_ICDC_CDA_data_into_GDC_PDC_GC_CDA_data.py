...
full_last_merged_dataset_name = 'merged_GDC_PDC_and_GC'

abbreviated_last_merged_dataset_name = 'GDC_PDC_GC'
...
tsv_output_dir = path.join( cda_root, 'merged_gdc_pdc_gc_and_icdc_002_decorated_harmonized' )
