...
extract-pdc pdc.jsonl.gz ../../data/pdc.files-specimens-cases.jsonl.gz --cases pdc-case-list.txt
...
extract-gdc gdc.files.jsonl.gz ../../data/gdc.files-specimens-cases.jsonl.gz --files gdc-file-list.txt  
python check-gdc-pull.py gdc.jsonl.gz gdc-case-list.txt

extract-pdc ../../data/pdc.all_cases.jsonl.gz ../../data/pdc.files-specimens-cases.jsonl.gz --files pdc-file-list.txt --files_out_file pdc.files.jsonl.gz
python check-pdc-pull.py pdc.jsonl.gz pdc-case-list.txt
