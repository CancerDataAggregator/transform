...
# Load (CDA) treatment.therapeutic_agent from (GC) treatment.therapeutic_agents and create a CDA treatment record for each GC treatment record.

print( f"[{get_current_timestamp()}] Loading (CDA) treatment.therapeutic_agent metadata from (GC) treatment.therapeutic_agents...", end='', file=sys.stderr )
