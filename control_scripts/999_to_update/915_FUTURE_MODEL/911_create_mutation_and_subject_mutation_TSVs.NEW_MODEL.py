...
from cda_etl.transform.mutation.mutation_transformer_NEW_MODEL import mutation_transformer_NEW_MODEL
...
mtx = mutation_transformer_NEW_MODEL(
...
mtx.make_mutation_table_and_associations()
