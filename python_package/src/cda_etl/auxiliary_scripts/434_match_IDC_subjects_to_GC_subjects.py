            ...
            if collection_id in idc_collection_id_to_gc_study_id:
                ...
                for gc_study_id in idc_collection_id_to_gc_study_id[collection_id]:
                    ...
                    if gc_study_id in gc_study_id_and_participant_id_to_cda_subject_alias and case_submitter_id in gc_study_id_and_participant_id_to_cda_subject_alias[gc_study_id]:
                        ...
                        if cda_subject_alias in idc_subject_alias_to_gc_subject_alias and idc_subject_alias_to_gc_subject_alias[cda_subject_alias] != gc_subject_alias:
                            
                            sys.exit( f"FATAL: One IDC CDA subject_alias ({cda_subject_alias}) mapped to two GC CDA subject aliases ({idc_subject_alias_to_gc_subject_alias[cda_subject_alias]} and {gc_subject_alias}); aborting." )

                        else:
                            
                            idc_subject_alias_to_gc_subject_alias[cda_subject_alias] = gc_subject_alias
...
with open( output_file, 'w' ) as OUT:
    ...
    for idc_subject_alias in sorted( idc_subject_alias_to_gc_subject_alias ):
        ...
        gc_subject_alias = idc_subject_alias_to_gc_subject_alias[idc_subject_alias]
