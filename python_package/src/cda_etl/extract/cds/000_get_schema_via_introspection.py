                    ...
                    for field in currentType['fields']:
                        ...
                        if field['args'] is not None and len(field['args']) > 0:
                            ...
                            for arg in field['args']:
                                ...
                                if arg['type']['kind'] == 'NON_NULL' and arg['type']['ofType']['kind'] == 'LIST' and arg['type']['ofType']['ofType']['kind'] == 'NON_NULL' and arg['type']['ofType']['ofType']['ofType']['kind'] in [ 'SCALAR', 'OBJECT', 'ENUM' ]:
                                    ...
                                    sys.exit( f"WTF? arg[type][name] is {arg['type']['name']}" )
                        ...
                        if field['type']['kind'] in ['SCALAR', 'OBJECT']:
                            ...
                            sys.exit( f"WTF? field[type][kind] is {field['type']['kind']}" )

                    print('}', file=OUT)

                else:
                    
                    sys.exit( f"WTF? currentType['kind'] is {currentType['kind']}" )
