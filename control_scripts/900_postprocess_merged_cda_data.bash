...
full_count_output_dir=./auxiliary_metadata/__column_value_statistics/merged_CDA_data/GDC_${gdc_extraction_date_string}_plus_PDC_${pdc_extraction_date_string}_plus_GC_${gc_extraction_date_string}_plus_ICDC_${icdc_extraction_date_string}_plus_IDC_${idc_extraction_date_string}/full_counts_by_column_and_value
