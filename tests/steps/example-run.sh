...
extract-gdc gdc_TARGET_case1.jsonl.gz gdc.samples-per-file.jsonl.gz gdc_fileuuid_gs.jsonl.gz --case 7eeced68-1717-4116-bcee-328ac70a9682
extract-gdc gdc_TARGET_case2.jsonl.gz gdc.samples-per-file.jsonl.gz gdc_fileuuid_gs.jsonl.gz --case 9e229e56-f7e1-58f9-984b-a9453be5dc9a
