...
extraction_date_file=./extracted_data/idc/extraction_date.txt

extraction_date_string=`cat $extraction_date_file`

input_root=./extracted_data/idc

summary_output_dir=./auxiliary_metadata/__column_value_statistics/IDC/extracted__${extraction_date_string}/dataset_summaries

summary_file="${summary_output_dir}/IDC_column_stats_by_table.as_extracted.tsv"
...
full_count_output_dir=./auxiliary_metadata/__column_value_statistics/IDC/extracted__${extraction_date_string}/full_counts_by_column_and_value
...
summary_file="${summary_output_dir}/IDC_column_stats_by_table.converted_to_CDA.unharmonized.tsv"
...
summary_file="${summary_output_dir}/IDC_column_stats_by_table.converted_to_CDA.harmonized.tsv"
...
output_dir=./cda_tsvs/idc_002_decorated_harmonized

version_file=./extracted_data/idc/data_version.txt
