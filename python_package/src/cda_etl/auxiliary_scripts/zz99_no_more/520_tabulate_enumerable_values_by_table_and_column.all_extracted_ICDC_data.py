...
dir_to_scan = path.join( 'extracted_data', 'icdc' )

output_dir = path.join( 'auxiliary_metadata', '__column_stats', '__full_count_data', 'ICDC' )
...
target_columns = columns_to_count( 'icdc' )
