...
my $in_file = './auxiliary_metadata/__DICOM_code_maps/raw/part04.xml';

my $out_file = './auxiliary_metadata/__DICOM_code_maps/retired_SOPClassUID.tsv';
