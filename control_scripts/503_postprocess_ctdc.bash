...
version_file="${extraction_root}/data_version_as_fetch_date.txt"
...
summary_file="${summary_output_dir}/${upper_data_source}_column_stats_by_table.as_extracted.QCd_collated_filtered_nonredundant.tsv"
...
full_count_output_dir="${full_count_output_root}/000_extracted_QCd_collated_filtered_nonredundant"
