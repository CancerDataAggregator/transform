...
file_table = path.join( 'extracted_data', 'gc', 'file.tsv' )

output_dir = path.join( 'auxiliary_metadata', '__GC_supplemental_metadata' )

output_file = path.join( output_dir, 'format_assertions_by_file_extension.GC.tsv' )
...
# maximal useful extension sequences. Validated by hand 2025-10-21.
