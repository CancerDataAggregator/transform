    ...
    res_subj = [
        {
            ...
            "associated_project": lower(orig.get("project_submitter_id")),
        }
    ]
...
def specimen_from_entity(entity, _type, parent_id, sample, case):
    ...
    return {
        ...
        "identifier": [{"value": entity.get(identifier_key), "system": "PDC"}],
        ...
        "associated_project": lower(case.get("project_submitter_id")),
...
def harmonized_files(files, case):
    ...
    for fil in files:
        ...
        this_file["associated_project"] = lower(case.get("project_submitter_id"))
