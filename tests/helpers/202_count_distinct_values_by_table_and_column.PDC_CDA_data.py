...
input_root = path.join( '006_transform_to_CDA_before_GDC_merge', 'transformed_data', 'pdc' )

stats_dir = path.join( input_root, '__column_stats' )

stats_file = path.join( stats_dir, 'column_stats_by_table.tsv' )
