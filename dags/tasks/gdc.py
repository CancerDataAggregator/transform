...
def gdc_transform_cases(uuid: str, extract_result: ExtractionResult, **kwargs):
    ...
    return transform_case_or_file(
        ...
        input_files=extract_result.file_list(),
        output_file=output_file,
        endpoint="cases",
        yaml_mapping_transform_file="GDC_subject_endpoint_mapping.yml")

@task(task_id="gdc_transform")
def gdc_transform_files(uuid: str, extract_result: ExtractionResult, **kwargs):
