...
extraction_root="./extracted_data/${data_source}_initial_database_dump"

extraction_date_file="${extraction_root}/${data_source}_extraction_date.txt"

extraction_date_string=`cat $extraction_date_file`

version_file="${extraction_root}/${data_source}_version.txt"

version_string=`cat $version_file`

input_root="./extracted_data/${data_source}"
