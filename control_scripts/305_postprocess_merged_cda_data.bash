...
then
    ...
    echo
    echo "   ERROR: Usage: $script_name <CDA version name, e.g. \"June 2026\">"
    echo
    exit 0
fi
...
input_root=./cda_tsvs/merged_gdc_pdc_gc_and_icdc_002_decorated_harmonized

summary_output_dir=./auxiliary_metadata/__column_value_statistics/merged_CDA_data/GDC_${gdc_extraction_date_string}_plus_PDC_${pdc_extraction_date_string}_plus_GC_${gc_extraction_date_string}_plus_ICDC_${icdc_extraction_date_string}/dataset_summaries

summary_file="${summary_output_dir}/GDC_plus_PDC_plus_GC_plus_ICDC.converted_to_CDA.harmonized.merged.counts_by_upstream_data_source.tsv"
