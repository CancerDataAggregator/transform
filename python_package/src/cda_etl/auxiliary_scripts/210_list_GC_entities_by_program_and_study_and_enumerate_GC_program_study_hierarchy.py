...
input_root = path.join( 'extracted_data', 'gc' )
...
output_dir = path.join( 'auxiliary_metadata', '__GC_supplemental_metadata' )

entity_output_file = path.join( output_dir, 'GC_entities_by_program_and_study.tsv' )

project_output_file = path.join( output_dir, 'GC_all_programs_and_studies.tsv' )
...
with open( project_output_file, 'w' ) as OUT:
    ...
    # As of March 2025, not all GC studies have to be in programs.
