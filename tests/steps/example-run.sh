...
extract-pdc pdc_QC1_case1.jsonl.gz ../../data/pdc.files-per-sample-dict.jsonl.gz --case 0809987b-1fba-11e9-b7f8-0a80fada099c
extract-pdc pdc_QC1_case2.jsonl.gz ../../data/pdc.files-per-sample-dict.jsonl.gz --case df4f2aaf-8f98-11ea-b1fd-0aad30af8a83
