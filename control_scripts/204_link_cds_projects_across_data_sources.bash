...
echo ./package_root/auxiliary_scripts/211_draft_CDS_GDC_project_links_using_submitter_IDs.pl $cds_entity_list $gdc_entity_list $output_file
./package_root/auxiliary_scripts/211_draft_CDS_GDC_project_links_using_submitter_IDs.pl $cds_entity_list $gdc_entity_list $output_file
...
echo ./package_root/auxiliary_scripts/212_draft_CDS_PDC_project_links_using_submitter_IDs.pl $cds_entity_list $pdc_entity_list $output_file
./package_root/auxiliary_scripts/212_draft_CDS_PDC_project_links_using_submitter_IDs.pl $cds_entity_list $pdc_entity_list $output_file
