...
worker_script=tests/helpers/001_naively_equate_PDC_project_and_study_submitter_IDs_to_IDC_collection_IDs.pl
...
output_file=extracted_data/idc/v13/__supplemental_metadata/naive_IDC-PDC_project_id_map.tsv
