...
with open( output_file, 'w' ) as OUT:
    ...
    for table_name in sorted( column_metadata ):
        ...
        for column_name in column_metadata[table_name]:
            ...
            concept = ''
            if 'concept' in current_record:
                concept = current_record['concept']
            ...
            print( *[ table_name, column_name, current_record['column_type'], concept, current_record['summary_returns'], current_record['data_returns'], process_before_display, virtual_table ], sep='\t', file=OUT )
